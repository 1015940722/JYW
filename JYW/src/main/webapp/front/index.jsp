	...
	<div class="Mak-Container">
		...
		<div class="Mak-Wrap-1">
			...
			<div class="Mak-Nav-S1">
				<nav>
					...
					<a href="r/release.html">发布商品</a>
					<a href="P/main.htm">个人中心</a>
		...
		<div class="Mak-Wrap-2" id="Mak-Wrap-2">
			...
			<div class="hot-sale">
		        ...
		        <div class="content">
			        <div class="content-1">
			        	<p class="hot-more"><a href="t/thingslist.html">更多&nbsp;>></a></p>
			        	<c:forEach items="${t1}" var="t1" >
			        		<section class="hot-product">
			    				<img src='fileupload/${t1.tPic}'>
			    				<span>
			    					<a href="t/tcontent.html?id=${t1.tId}">UnderArmour安德玛美国队长蝙蝠侠 </a>
			    					<a class="Price">￥${t1.tPrice}</a>
