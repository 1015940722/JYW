			...
			<ol class="breadcrumb route-color">
		  	...
		  	<div class="trade-content">
		  		...
		  		<div class="trade-item">
		  			<c:forEach items="${things}" var="things">
		  				<div class="item1">
		  				<span><img src=fileupload/${things.tPic}></span>
		  				<span>
		  					<p ><a href="t/tcontent.html?id=${things.tId}"><b>${things.tName}</b></a></p>
		  				...
		  				<span class="pull-right item-price">
		  					<p><a class="price-text">${things.tPrice }</a> 元</p>
		  					<p><a href="#">${things.tUName}</a></p>
		  				</span>
		  			</div>
		  			</c:forEach>
